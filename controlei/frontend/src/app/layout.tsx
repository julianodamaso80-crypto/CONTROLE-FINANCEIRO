...
const themeInitScript = `(function(){try{var t=localStorage.getItem('controlei-theme')||'dark';var r=document.documentElement;if(t==='dark'){r.classList.add('dark')}else{r.classList.remove('dark')}r.style.colorScheme=t;}catch(e){document.documentElement.classList.add('dark')}})();`;
...
export default function RootLayout({
  ...
  return (
    <html
      lang="pt-BR"
      className={`${interTight.variable} ${fraunces.variable} overflow-x-hidden`}
