...
> Quer testar registro por áudio sem precisar baixar app? [Conheça os planos do Controlei](/#planos) — manda áudio direto no WhatsApp e IA registra.
...
> Pra testar áudio + transcrição + categorização automática sem cadastro complexo, [veja os planos do Controlei](/#planos) — manda áudio no WhatsApp e IA confirma em segundos.
...
O Controlei aceita áudio direto pelo WhatsApp — você manda, IA transcreve, classifica e confirma em 3 segundos. Sem fricção, sem digitar. [Quero ver os planos](/#planos) — 3 dias grátis e sem cartão.
