...
> Quer ver na prática como seus gastos atuais se encaixam nessa divisão? [Cadastre-se grátis no Controlei](/#planos) — em 30 dias você tem o relatório completo, classificado automaticamente.
...
> Quer aplicar o 50/30/20 sem montar planilha? [Veja os planos do Controlei](/#planos) — a IA mostra os 3 blocos automaticamente no relatório PDF mensal.

Antes de aplicar o 50/30/20, vale entender o panorama completo de [7 métodos pra controlar gastos mensais](/blog/como-controlar-gastos-mensais-7-metodos) — assim você escolhe a ferramenta certa. Se você está endividado e os 20% não dão conta, leia também [Como sair das dívidas em 2026: plano em 6 passos](/blog/como-sair-das-dividas-em-2026-passo-a-passo).
