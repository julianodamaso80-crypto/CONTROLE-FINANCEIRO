...
> Quer ver TODOS esses tipos de gasto categorizados sem fazer auditoria manual? [Conheça os planos do Controlei](/#planos) — em 30 dias o relatório PDF mostra cada vazamento.
...
Cada banco só mostra os SEUS próprios gastos. Se você tem conta no Nubank + cartão no Inter + débito no Itaú, cada um mostra um pedaço. Sem visão consolidada. Pra resolver, ou centraliza tudo em 1 banco OU usa app de finanças que junta tudo (ou bot WhatsApp como [Controlei](/blog/controle-financeiro-pelo-whatsapp-passo-a-passo)).
...
> Quer fazer essa auditoria mensalmente sem planilha? [Veja os planos do Controlei](/#planos) — relatório PDF mostra TODOS os gastos categorizados em 3 cliques.
...
O Controlei registra cada despesa que você manda pelo WhatsApp e gera relatório PDF mensal categorizado. Você vê na hora os 5 tipos de gasto invisível sem precisar baixar CSV nem fazer somatório manual. [Quero ver os planos](/#planos) — 3 dias grátis e sem cartão.
