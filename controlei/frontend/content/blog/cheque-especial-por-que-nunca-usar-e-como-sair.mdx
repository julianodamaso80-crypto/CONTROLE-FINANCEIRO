...
> Quer ver quanto está pagando de juros de cheque especial mensalmente? [Conheça os planos do Controlei](/#planos) — relatório PDF identifica linha "juros bancários" separadamente.
...
> Quer aviso semanal automático no WhatsApp se gastos crescerem? [Veja os planos do Controlei](/#planos) — alertas inteligentes pra evitar surpresa no fim do mês.
...
O Controlei identifica linha "juros e tarifas bancárias" separadamente — você vê quanto saiu pra banco em vez de pra você. Visibilidade pra agir. [Quero ver os planos](/#planos) — 3 dias grátis, sem cartão.
