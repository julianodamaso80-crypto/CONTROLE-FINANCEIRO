...
> Quer regras automáticas pra dispensar pelo WhatsApp em hora de gasto? [Conheça os planos do Controlei](/#planos) — alertas inteligentes pra ajudar disciplina.
...
O Controlei categoriza despesas como fixa ou variável automaticamente — você vê preto no branco onde economia está acontecendo. [Quero ver os planos](/#planos) — 3 dias grátis, sem cartão.
