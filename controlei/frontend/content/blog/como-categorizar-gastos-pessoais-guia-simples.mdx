...
> Quer ver suas despesas categorizadas automaticamente em 5 blocos sem precisar montar planilha? [Conheça os planos do Controlei](/#planos) — você manda o gasto pelo WhatsApp e a IA já enquadra.
...
> Quer registrar e categorizar sem precisar abrir app? [Veja os planos do Controlei](/#planos) — manda gasto pelo WhatsApp, a IA categoriza e gera relatório PDF mensal.
...
O Controlei categoriza cada gasto que você manda pelo WhatsApp em uma das 5 grandes áreas automaticamente. No fim do mês, relatório PDF mostra quanto foi em cada bloco e onde está estourando. Sem decidir categoria manualmente lançamento por lançamento. [Quero ver os planos](/#planos) — 3 dias grátis e sem cartão.
