...
> Quer testar notificação inteligente no WhatsApp em um app real? [Conheça os planos do Controlei](/#planos) — 3 dias grátis pra avaliar alertas em casos reais.
...
> Quer ativar notificação inteligente sem precisar instalar mais um app? [Veja os planos do Controlei](/#planos) — alertas no WhatsApp, fácil de configurar.
...
Em apps de banco (Nubank, Inter, C6) geralmente é gratuita básica (alerta de transação). Análise avançada de padrão (gasto compulsivo, assinatura suspeita) costuma vir em apps pagos (Mobills Pro, Olivia, Controlei).
...
O Controlei envia notificação direto no WhatsApp quando detecta gasto atípico — você confirma ou contesta direto na conversa. Sem app novo pra baixar. [Quero ver os planos](/#planos) — 3 dias grátis, sem cartão.
