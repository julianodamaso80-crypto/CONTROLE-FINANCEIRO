...
> Quer enxergar todas suas dívidas e gastos num só lugar pra começar o passo 2? [Cadastre-se grátis no Controlei](/#planos) — em 30 dias você tem o diagnóstico completo, sem planilha.
...
> Pronto pra montar seu plano de saída? [Ver planos do Controlei](/#planos) — pra ver onde cortar gasto e direcionar pras dívidas com clareza.

Antes de atacar dívidas, é fundamental ter visibilidade dos gastos atuais — veja [7 métodos pra controlar gastos mensais](/blog/como-controlar-gastos-mensais-7-metodos). Depois de pagar as dívidas, aplica [o método 50/30/20 pra blindar](/blog/metodo-50-30-20-como-dividir-salario) e considera [registrar gastos pelo WhatsApp](/blog/controle-financeiro-pelo-whatsapp-passo-a-passo) pra manter o hábito sem fricção.
...
O Controlei registra cada gasto que você manda pelo WhatsApp e mostra o panorama completo do mês — categorias, totais, comparação com mês anterior. Sem isso, é impossível executar o plano dos 6 passos (você não sabe onde cortar pra direcionar pras dívidas). [Quero testar agora](/#planos) — 3 dias grátis, sem cartão.
