...
> Quer testar app com Meta Cloud API oficial + DPO + LGPD cumprida? [Conheça os planos do Meu Caixa](/#planos) — 3 dias grátis pra avaliar transparência.
...
> Pra serviço que NUNCA pede senha do banco e respeita LGPD desde o primeiro dia, [veja os planos do Meu Caixa](/#planos) — 3 dias grátis sem cartão.
...
O Meu Caixa tem DPO designado, criptografia AES-256, exportação em 1 clique e usa Meta Cloud API oficial. Você controla seus dados desde o primeiro dia. [Quero ver os planos](/#planos) — 3 dias grátis e sem cartão.
