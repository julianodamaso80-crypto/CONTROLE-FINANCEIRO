...
> Quer testar app que oferece categorias customizáveis sem virar caos? [Conheça os planos do Meu Caixa](/#planos) — 3 dias grátis pra testar configuração ideal.
...
O Meu Caixa permite categorias padrão + customizáveis pelo WhatsApp. 3 dias grátis pra testar sua configuração ideal. [Quero ver os planos](/#planos) — sem cartão.
