...
> Quer ver TODAS suas despesas anuais previstas pro próximo ano? [Conheça os planos do Meu Caixa](/#planos) — relatório mensal lista vencimentos futuros automaticamente.
...
> Quer registrar provisão como categoria separada e ver evolução mensal? [Veja os planos do Meu Caixa](/#planos) — relatório PDF mostra acumulado das provisões.
...
O Meu Caixa permite categorizar despesas anuais separadamente e mostra mês a mês quanto você provisionou. No dia do vencimento, você sabe exatamente que o dinheiro está lá. [Quero ver os planos](/#planos) — 3 dias grátis, sem cartão.
