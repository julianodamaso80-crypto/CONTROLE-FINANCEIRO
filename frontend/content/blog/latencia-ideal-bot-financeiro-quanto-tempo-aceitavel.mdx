...
> Quer testar bot com latência otimizada (3-5 segundos típicos)? [Conheça os planos do Meu Caixa](/#planos) — 3 dias grátis pra cronometrar.
...
O Meu Caixa usa Gemini 2.5 Flash com arquitetura otimizada — registro de gasto em 2-3 segundos típicos. Cronometra você mesmo. [Quero ver os planos](/#planos) — 3 dias grátis, sem cartão.
